...
# New data into Studio model 
new_studio = Studio.new
new_studio["name"] = "Warner Bros."
new_studio.save # actually add to table


# New data into Movie model
...
# Look at movies data and loop through to show movie output. 
...
#  Now, for each movie: Get all roles; then for each role, get the actor for that role.
